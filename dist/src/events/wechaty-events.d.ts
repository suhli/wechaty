...
import { Puppet, ScanStatus } from 'wechaty-puppet';
import { Friendship, ContactSelf, Room, RoomInvitation, Contact, Message } from '../user/mod';
 ...
 */
export declare type WechatyDongEventListener = (data?: string) => void;
export declare type WechatyErrorEventListener = (error: Error) => void;
export declare type WechatyFriendshipEventListener = (friendship: Friendship) => void;
export declare type WechatyHeartbeatEventListener = (data: any) => void;
export declare type WechatyLoginEventListener = (user: ContactSelf) => void;
export declare type WechatyLogoutEventListener = (user: ContactSelf, reason?: string) => void;
export declare type WechatyMessageEventListener = (message: Message) => void;
export declare type WechatyPuppetEventListener = (puppet: Puppet) => void;
export declare type WechatyReadyEventListener = () => void;
export declare type WechatyRoomInviteEventListener = (roomInvitation: RoomInvitation) => void;
export declare type WechatyRoomJoinEventListener = (room: Room, inviteeList: Contact[], inviter: Contact, date?: Date) => void;
export declare type WechatyRoomLeaveEventListener = (room: Room, leaverList: Contact[], remover?: Contact, date?: Date) => void;
export declare type WechatyRoomTopicEventListener = (room: Room, newTopic: string, oldTopic: string, changer: Contact, date?: Date) => void;
export declare type WechatyScanEventListener = (qrcode: string, status: ScanStatus, data?: string) => void;
export declare type WechatyStartStopEventListener = () => void;
/**
...
export declare const WechatyEventEmitter: new () => TypedEventEmitter<WechatyEvents>;
export {};
