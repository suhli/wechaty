...
blue_tape_1.default('say()', async () => {
    ...
    await contact2.sync();
    await room.sync();
    blue_tape_1.default('say with Tagged Template', async (t) => {
    ...
    blue_tape_1.default('say with regular mention contact', async (t) => {
        callback.resetHistory();
    ...
    blue_tape_1.default('say with multiple mention contact', async (t) => {
        callback.resetHistory();
