...
tstest_1.test('stripHtml()', async (t) => {
...
tstest_1.test('unescapeHtml()', async (t) => {
...
tstest_1.test('plainText()', async (t) => {
...
tstest_1.test('digestEmoji()', async (t) => {
    const EMOJI_XML = [
...
tstest_1.test('unifyEmoji()', async (t) => {
...
tstest_1.test('stripEmoji()', async (t) => {
    const EMOJI_STR = [
        [
